% Runs an Open Loop Waveform streaming Test which makes the user able to test
...
function externalOutput()
   ...
   res = engine.runCompleteOpenLoopWaveformStreamingTest(path, 1);
end
...
function externalInput()
   ...
   % The results from the test will be saved in the res variable. If the plots are active you have to close them before the function returns
   res = engine.runPlaybackOpenLoopWaveformStreamingTest(1, path);
end
