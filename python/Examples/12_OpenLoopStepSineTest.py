...
# Runs an Open Loop Step Sine Test which makes the user able to test an output or an input that is not directly
...
def externalOutput():
    ...
    res = engine.RunCompleteOpenLoopStepSineTest(1, triggerLevel=0.3, level=0.5, minCycles=10, minDuration=0.3,
                                           stepIncrement=1, startFrequency=20, endFrequency=20e3)
...
def externalInput():
    ...
    # The results from the test will be saved in the res variable. If the plots are active you have to close them before the function returns
    res = engine.RunPlaybackOpenLoopStepSineTest(1, minCycles=10, minDuration=0.3, stepIncrement=1, startFrequency=20, endFrequency=20e3)
