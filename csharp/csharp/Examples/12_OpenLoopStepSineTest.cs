...
{
    //Runs an Open Loop Step Sine Test which makes the user able to test an output or an input that is not directly connected to the 3670-A. 
    class OpenLoopStepSineTest
    {
        ...
        private static void ExternalOutput()
        {
            ...
            var res = engine.RunCompleteOpenLoopStepSineTest(1,
															 triggerLevel: 0.3,
															 level: 0.5,
															 minCycles: 10,
															 minDuration: 0.3,
        ...
        private static void ExternalInput()
        {
            ...
            // The results from the test will be saved in the res variable. If the plots are active you have to close them before the function returns
            var res = engine.RunPlaybackOpenLoopStepSineTest(1,
															 minCycles: 10,
															 minDuration: 0.3,
															 stepIncrement: 1,
															 startFrequency: 20,
